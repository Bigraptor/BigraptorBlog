...
import { postPaginationRequest, postCurrentPage, postNextPage, postPrevious } from "../../actions/post";
...
class Pagination extends Component {
    ...
    constructor(props){
        super(props);
        this.state = {
            firstpage : Math.floor((window.location.href.split("/")[4]*1 - 1) / 10) * 10 + 1,
            lastpage : 1,
            pagelist : []
        };
    ...
    componentDidMount(){
        this.props.postpaginationrequest().then(
            () => {
                ...
                if(typeof window.location.href.split("/")[4]==="undefined"){
                    ...
                    this.props.postCurrentPage(window.location.href.split("/")[4]*1);
                };
            }
        );
    };
            ...
            <div>
                <ul className= {cx("pagination")}>
                    <li className={cx("first", {
                        ...
                        <a href = {"/page/"+this.props.paginationstatus.currentpage} onClick = {() => {this.props.postPrevious()}}>이전</a>
                    </li>
                    ...
                    <li className={cx("last", {
                        ...
                        <a href = {"/page/"+ this.props.paginationstatus.currentpage} onClick = {()=>{this.props.postNextPage()}}
...
export const mapDispatchToProps = (dispatch) => {
    return {
        postpaginationrequest : () => {
            return dispatch(postPaginationRequest());
        },
